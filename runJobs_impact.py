...
def runjob(masspoint, systag):
    ...
    if systag!="bkg" and systag!="signal" :
        ...
        command_addcommonSys="cat ./config/highmass_MCstat/Conf_ggH%s.txt >> %s"%(masspoint, newconfigfile)
...
##  copy limit file to ./impact/ directory
    ...
    command_cp_limit="cp ./HZZllvv_%s/Limits/HZZllvv_%s.root ./impact/HZZllvv_%s_%s.root"%(masspoint, masspoint, masspoint, systag)
...
#tags=["el", "mu", "jet", "met", "lumi", "pileup", "WZunc", "ZZunc", "Zjet", "bkg", "signal"]
#tags=["el", "mu", "jet", "met", "lumi", "pileup", "WZunc", "ZZunc", "Zjet"]

#tags=["el", "mu", "jet", "met", "lumi", "pileup", "WZunc", "ZZunc", "Zjet", "bkg", "signal","dummy", "ggZZunc", "signaltheo"]
tags=[ "Zjet"]
#tags=["signalZH"]
