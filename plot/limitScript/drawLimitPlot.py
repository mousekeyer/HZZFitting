...
theory_xs=get_cxs("./CrossSections/XSfiles/XS_EWS_sina60_tanb4.txt", masses)
theory_xs2=get_cxs("./CrossSections/XSfiles/XS_EWS_sina70_tanb20.txt", masses)
theory_xs3=get_cxs("./CrossSections/XSfiles/XS_EWS_sina90_tanb5.txt", masses)
...
for i in range(0,len(medians)):
    ...
    sm.append(theory_xs[i])
    sm2.append(theory_xs2[i])
    sm3.append(theory_xs3[i])
...
outputtexfile=open("limitNumbers.tex", "w")
title='''
\\begin{table}
\\begin{center}
...
sm_pred.SetLineStyle(3)
sm_pred.SetLineColor(R.kBlue)
#sm_pred.Draw("L,same")

sm_pred2 = PyROOTUtils.Graph(masses, sm2)
sm_pred2.SetLineWidth(2)
sm_pred2.SetLineStyle(3)
sm_pred2.SetLineColor(R.kRed)
#sm_pred2.Draw("L,same")

sm_pred3 = PyROOTUtils.Graph(masses, sm3)
sm_pred3.SetLineWidth(2)
sm_pred3.SetLineStyle(3)
sm_pred3.SetLineColor(R.kMagenta)
#sm_pred3.Draw("L,same")
...
leg2=R.TLegend(0.5,0.55,0.9,0.7)
#leg2.SetTextFont(42)
leg2.AddEntry(sm_pred, "EWS: sin#alpha=0.6, tan#beta=0.4", "l")
leg2.AddEntry(sm_pred2, "EWS: sin#alpha=0.7, tan#beta=2.0", "l")
leg2.AddEntry(sm_pred3, "EWS: sin#alpha=0.9, tan#beta=0.5", "l")
...
AtlasUtil.DrawText(col_l, 0.71, "H #rightarrow ZZ #rightarrow ll#nu#nu", size=0.037)
if (mode=='VBF'):
