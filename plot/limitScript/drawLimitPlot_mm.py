...
outputtexfile=open("limitNumbers_mm.tex", "w")
title='''
\\begin{table}
\\begin{center}
...
AtlasUtil.DrawText(col_l, 0.71, "H #rightarrow ZZ #rightarrow #mu#mu#nu#nu", size=0.037)
if (mode=='VBF'):
    AtlasUtil.DrawText(col_l, 0.66, "VBF", size=0.037)
else:
    AtlasUtil.DrawText(col_l, 0.66, "ggF", size=0.037)

c.SaveAs("./limitplots/"+tag+"XSEC_NEW_mm.png")
c.SaveAs("./limitplots/"+tag+"XSEC_NEW_mm.eps")
c.SaveAs("./limitplots/"+tag+"XSEC_NEW_mm.pdf")
